  ...
  <body> 
    <script> popupku(); </script>
     ...
     <div class="preload"> 
      ...
      <div class="open"> <div> <div class="lope" onclick="ilang()"><i class="love material-icons-sharp"> favorite </i></div> 
        <h3>Special Message to Dinda</h3> 
        <h3>Click Love to Open!</h3> 
      </div> </div> 
      <div class="bg"></div> <div class="lopeBgs"></div>

    <div class="top stiker"><img src="" /><img src="" /><img src="" /></div><div class="ucapan">
      <div id="slider">
    <!-- Ucapan awal -->
        <p>Hallo Dinda, ini iyo..</p>
    
    <!-- Pertanyaan -->
        <p>Can i know more about you?</p>
      </div><div id="slider">
    <!-- Ucapan diterima -->
        <p>Yes!! Thank you!</p>
      </div>
